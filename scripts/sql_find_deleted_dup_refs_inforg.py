...
def main() -> int:
    ...
    md_path = LOG_DIR / f'deleted_dup_inforg_refs_{ts}.md'
    csv_path = LOG_DIR / f'deleted_dup_inforg_refs_{ts}.csv'
    ...
    with connect() as conn:
        with conn.cursor() as cur:
            ...
            if not ids:
                md_path.write_text('# Deleted duplicate inforg refs\n\nNo deleted [ДУБЛЬ] refs found in _chrc2105.\n', encoding='utf-8')
    ...
    lines = [
        '# Deleted duplicate refs in _inforg tables',
        '',
